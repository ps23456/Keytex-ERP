...
import { Plus, Settings, Cog, Layers, FileText, RefreshCw, AlertTriangle } from 'lucide-react'

const productionTabs = [
  { key: 'work_center', label: 'Work Center Master', icon: Settings },
  { key: 'operation', label: 'Operation Master', icon: Cog },
  { key: 'process', label: 'Process Master', icon: Layers },
  { key: 'drawing', label: 'Drawing Master', icon: FileText },
  { key: 'rework_reason', label: 'Rework Reason Master', icon: RefreshCw },
  { key: 'downtime_reason', label: 'Downtime Reason Master', icon: AlertTriangle }
]

export default function ProductionMasterManagement() {
  const [activeTab, setActiveTab] = useState('work_center')
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Production & Operations Masters</h1>
          <p className="text-gray-600 mt-1">Manage work centers, operations, processes, drawings, and quality control masters</p>
        </div>
