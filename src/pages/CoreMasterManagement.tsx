...
const masterTabs = [
  ...
  { key: 'branch', label: 'Branch / Site', icon: Database },
  { key: 'department', label: 'Department', icon: Settings },
  { key: 'user', label: 'User', icon: Database },
  { key: 'role', label: 'Role', icon: Settings },
  { key: 'employee', label: 'Employee', icon: Database },
  { key: 'machine', label: 'Machine', icon: Settings },
  { key: 'tool', label: 'Tool & Fixture', icon: Database },
  { key: 'shift', label: 'Shift', icon: Settings },
  { key: 'currency', label: 'Currency', icon: Database },
  { key: 'tax', label: 'Tax', icon: Settings }
]

export default function CoreMasterManagement() {
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Core Master Management</h1>
          <p className="text-gray-600 mt-1">Manage master data for the ERP system</p>
        </div>
