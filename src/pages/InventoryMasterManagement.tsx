...
import { Plus, Package, FolderTree, Warehouse, Layers, Settings, FileText, Route, Microscope } from 'lucide-react'


const inventoryTabs = [
  { key: 'item', label: 'Item Master', icon: Package },
  { key: 'item_category', label: 'Item Category', icon: FolderTree },
  { key: 'warehouse', label: 'Warehouse', icon: Warehouse },
  { key: 'batch', label: 'Batch Master', icon: Layers },
  { key: 'material_type', label: 'Material Type', icon: Settings },
  { key: 'bom', label: 'BOM Master', icon: FileText },
  { key: 'routing', label: 'Routing Master', icon: Route },
  { key: 'material_specification', label: 'Material Specification', icon: Microscope }
]

export default function InventoryMasterManagement() {
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Inventory & Material Masters</h1>
          <p className="text-gray-600 mt-1">Manage inventory items, categories, warehouses, batches, and production specifications</p>
        </div>
