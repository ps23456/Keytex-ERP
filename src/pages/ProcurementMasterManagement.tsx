...
import { Plus, Users, Star, ShoppingCart, Clock, Wrench } from 'lucide-react'

const procurementTabs = [
  { key: 'supplier', label: 'Supplier Master', icon: Users },
  { key: 'supplier_rating', label: 'Supplier Rating Master', icon: Star },
  { key: 'purchase_type', label: 'Purchase Type Master', icon: ShoppingCart },
  { key: 'lead_time', label: 'Lead Time Master', icon: Clock },
  { key: 'subcontractor', label: 'Subcontractor Master', icon: Wrench }
]

export default function ProcurementMasterManagement() {
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Procurement & Vendor Masters</h1>
          <p className="text-gray-600 mt-1">Manage suppliers, ratings, purchase types, lead times, and subcontractors</p>
        </div>
