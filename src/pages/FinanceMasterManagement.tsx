...
import { Plus, Calculator, Building2, CreditCard, Clock, Receipt, BookOpen, FileText, Percent } from 'lucide-react'

const financeTabs = [
  { key: 'chart_of_accounts', label: 'Chart of Accounts', icon: Calculator },
  { key: 'cost_center', label: 'Cost Center', icon: Building2 },
  { key: 'bank_account', label: 'Bank Account', icon: CreditCard },
  { key: 'payment_terms', label: 'Payment Terms', icon: Clock },
  { key: 'tax_type', label: 'Tax Type', icon: Percent },
  { key: 'tax_master', label: 'Tax Master', icon: Receipt },
  { key: 'ledger_master', label: 'Ledger Master', icon: BookOpen },
  { key: 'expense_type', label: 'Expense Type', icon: FileText }
]

export default function FinanceMasterManagement() {
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Finance & Accounting Masters</h1>
          <p className="text-gray-600 mt-1">Manage chart of accounts, cost centers, bank accounts, payment terms, tax types, tax masters, ledger masters, and expense types</p>
        </div>
