...
import { Plus, Workflow, Bell, FileText, QrCode, Link } from 'lucide-react'

const configTabs = [
  { key: 'approval_workflow', label: 'Approval Workflow', icon: Workflow },
  { key: 'notification_alert', label: 'Notification & Alert', icon: Bell },
  { key: 'document_type', label: 'Document Type', icon: FileText },
  { key: 'barcode_qr_setup', label: 'Barcode / QR Setup', icon: QrCode },
  { key: 'integration_master', label: 'Integration Master', icon: Link }
]

export default function ConfigurationMasterManagement() {
  const [activeTab, setActiveTab] = useState('approval_workflow')
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Configuration & Utility Masters</h1>
          <p className="text-gray-600 mt-1">Manage approval workflows, notifications, document types, barcode/QR setups, and external integrations</p>
        </div>
