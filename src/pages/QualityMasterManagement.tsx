...
import { Plus, CheckSquare, ClipboardList, FileText, XCircle, AlertTriangle, Wrench, Settings } from 'lucide-react'

const qualityTabs = [
  { key: 'qc_parameter', label: 'QC Parameter Master', icon: CheckSquare },
  { key: 'sampling_plan', label: 'Sampling Plan Master', icon: ClipboardList },
  { key: 'inspection_template', label: 'Inspection Template Master', icon: FileText },
  { key: 'rejection_code', label: 'Rejection Code Master', icon: XCircle },
  { key: 'ncr_type', label: 'NCR Type Master', icon: AlertTriangle },
  { key: 'maintenance_schedule', label: 'Maintenance Schedule Master', icon: Wrench },
  { key: 'tool_life', label: 'Tool Life Master', icon: Settings }
]

export default function QualityMasterManagement() {
  const [activeTab, setActiveTab] = useState('qc_parameter')
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Quality & Maintenance Masters</h1>
          <p className="text-gray-600 mt-1">Manage QC parameters, inspection templates, rejection codes, NCR types, maintenance schedules, and tool life</p>
        </div>
