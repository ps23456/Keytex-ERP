...
import { Plus, Users, Tag, DollarSign, MapPin, Truck, CreditCard } from 'lucide-react'

const salesTabs = [
  { key: 'customer', label: 'Customer Master', icon: Users },
  { key: 'customer_type', label: 'Customer Type Master', icon: Tag },
  { key: 'price_list', label: 'Price List Master', icon: DollarSign },
  { key: 'dispatch_location', label: 'Dispatch Location Master', icon: MapPin },
  { key: 'transporter', label: 'Transporter Master', icon: Truck },
  { key: 'credit_limit', label: 'Credit Limit Master', icon: CreditCard }
]

export default function SalesMasterManagement() {
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Sales & Customer Masters</h1>
          <p className="text-gray-600 mt-1">Manage customers, pricing, dispatch locations, transporters, and credit limits</p>
        </div>
